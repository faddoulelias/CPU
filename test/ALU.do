...
add wave -radix binary  -position end  sim:/alu/OP
add wave -radix decimal -position end  sim:/alu/Bus_A
add wave -radix decimal -position end  sim:/alu/Bus_B
add wave -radix decimal -position end  sim:/alu/ALU_out
add wave -radix decimal -position end  sim:/alu/N
